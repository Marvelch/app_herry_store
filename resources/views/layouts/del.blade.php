                ...
                < meta name="viewport" content="width=device-width, initial-scale=1">
                    < meta http - equiv="x-ua-compatible" content="ie=edge">
                        < script src="https://cdn.jsdelivr.net/npm/vue/dist/vue.js">
                            < /script>
                                <title>Z-Invoice by mesinkasironline.web.app</title>
                                < link rel="stylesheet" href="{{asset('css/app.css')}}">
                                    < script src="{{asset('js/lara.js')}}" defer>
                                        < /script>
                                            <link rel="stylesheet"
                                                href="https:/ / stackpath.bootstrapcdn.com / bootstrap / 4.5 .0 / css / bootstrap.min.css "
                                                integrity="
sha384 - 9 aIt2nRpC12Uk9gS9baDl411NQApFmC26EwAOH8WgZl5MYYxFfc + NcPb1dKGj7Sk " crossorigin="
anonymous ">
                                            <style>
...
Laravel POS ", ssc4: "
Larapos Simple ", hc: "
www.hockeycomputindo.com ", ssc5: "
Laravel POS ", hcs: "
https: //www.hockeycomputindo.com", ssc6: "Laravel Angular", ffos: "Free open source code point of sale app present by", ads: "Add User", ssc6u: "https://www.hockeycomputindo.com/2021/01/cara-integrasi-laravel-angular-learn.html", acs: "Add Customer", lcsps: "List our source code laravel project", dbps: "Databased Products", ssc4u: "https://www.hockeycomputindo.com/2020/07/free-point-of-sale-laravel-pos-source.html", acg: "Add Categories", ssc3u: "https://www.hockeycomputindo.com/2021/12/laravel-website-cms-source-code-full.html", cnpdt: " Create New Product", ssc5u: "https://www.hockeycomputindo.com/2020/09/aplikasi-toko-gratis-download.html", apd: "Add Products", soc: "Source Code Gallery →", resto: "https://www.hockeycomputindo.com/p/resto.html", shp : "Retail Shop App", shop: "https://www.hockeycomputindo.com/p/toko.html", ssc2u: "https://www.hockeycomputindo.com/2021/02/new-laravel-blog-cms-free-download.html", title: "Z-INVOICE", rst: "Restaurant App", and: "Android Dev", opo: "Our Product", ssc1u: "https://www.hockeycomputindo.com/2020/09/larablog-laravel-cms-blog-with-seo.html", kasir: "POS Hardware", andro: "https://android.axcora.com", nav1: "Home", kasirs: "https://www.hockeycomputindo.com/p/daftar-mesin-kasir-terbaru.html", sslugu1: "https://www.hockeycomputindo.com/p/lavaapp-aplikasi-toko-grosir-dan-eceran.html", sslug1: "Lavapos", oss: "Our Services", socs: "https://www.hockeycomputindo.com/2010/12/blog-post.html", sslugu2: "https://www.hockeycomputindo.com/p/resto-cafe-website-modern-aplikasi.html", wbd: "Website Dev", sslug2: "Dexopos Resto", wbde: "https://website.axcora.com", sslugu3: "https://www.hockeycomputindo.com/p/website-keren-aplikasi-toko-android.html", lpor: "Laravel Pro", sslug3: "Dexopos Shop", sslugu4: "https://www.hockeycomputindo.com/p/new-restaurant-point-of-sale-pos-apps.html", sslug4: "Mr.Resto Pos", cc: "Create Categories", nav2: "Doc", ddps: "Download all source code project", cn: "Categorie Name", nav3: "Data", cnct: "Create New Categories", sv: "Save Data", ctndb: "Categories databased", nav4: "POS", ncsa: "New Customer", inc: "Income", nav5: "Report", pro: "PRO", rpt: "Report", rptdm: "Report details menu", nav6: "WebApp", xpr: "Export Report", pap: "Premium App", db: "Database", papa: "https://lava.axcora.my.id/", dbs: "Register Database in here", pfc: "Profit Income", us: "User", gpr: "Group Report", pdpr: "Product Report", cs: "Customer", nus: "Create new user", usdb: "User Databased Management", usb: "User Report", cdmb: "Customer Databased Management", csr: "Customer Report", wba: "https://www.hockeycomputindo.com/p/webapp.html",}'>
                                                <div class="wrapper">
                                                    <nav class="navbar navbar-expand-lg navbar-dark bg-dark text-white">
                                                        <a class="navbar-brand" href="/" x-text='title'></a> <button
                                                        ...
                                                        <div class="collapse navbar-collapse"
                                                            ...
                                                            <ul class="navbar-nav mr-auto p-1">
                                                                <li class="nav-item active"> <a href="{{route('home')}}"
                                                                        class="nav-link" x-text="nav1"> <svg
                                                                            class="bi bi-grid-1x2" width="1em"
                                                                ...
                                                                <li class="nav-item active"> <a
                                                                        ...
                                                                        x-text="nav2" class="nav-link"> <svg
                                                                            xmlns="http://www.w3.org/2000/svg"
                                                                ...
                                                                <li class="nav-item active"> <a href="{{route('data')}}"
                                                                        class="nav-link" x-text="nav3"> <svg
                                                                            xmlns="http://www.w3.org/2000/svg"
                                                                            width="16" height="16" fill="currentColor"
                                                                ...
                                                                <li class="nav-item active"> <a
                                                                        ...
                                                                        class="nav-link" x-text="nav4"> <svg
                                                                            class="bi bi-cart3" width="1em" height="1em"
                                                                ...
                                                                <li class="nav-item active"> <a
                                                                        href="{{route('office')}}" class="nav-link"
                                                                        x-text="nav5"> <svg class="bi bi-clipboard-data"
                                                                ...
                                                                <li class="nav-item active"> <a x-bind:href='wba'
                                                                        target="blank" class="nav-link" x-text="nav6">
                                                                        <svg width="1em" height="1em"
                                                                            viewBox="0 0 16 16" class="bi bi-controller"
                                                                            fill="currentColor"
                                                                            xmlns="http://www.w3.org/2000/svg">
                                                                            <path fill-rule="evenodd"
                                                                ...
                                                                <li class="nav-item active">
                                                                    <form action="{{route('logout')}}" method="POST">
                                                                        @csrf <button
                                                                            onclick="return confirm('Yakin akan log out ?')"
                                                                            type="submit"
                                                    ...
                                                    <div class="content-wrapper">
                                                        @include('auth.pos')@yield('content')@include('auth.passwords.admin')
                                                    </div>
                                                </div>
                                                ...
                                                <script src='https://mesinkasir.github.io/larapos/pos/gallerya.js'>
                                                </script>
                                                <script

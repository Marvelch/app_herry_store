...
<body class="bg-light"
    x-data='{ssc: "Larablog", ct: "Categories", ssc2: "Lavablog", pd: "Products", ssc3: "Lablog Sqlite", lp: "Laravel POS", ssc4: "Larapos Simple", hc: "www.hockeycomputindo.com", ssc5: "Laravel POS", hcs: "https://www.hockeycomputindo.com", ssc6: "Laravel Angular", ffos: "Free open source code point of sale app present by", ads: "Add User", ssc6u: "https://www.hockeycomputindo.com/2021/01/cara-integrasi-laravel-angular-learn.html", acs: "Add Customer", lcsps: "List our source code laravel project", dbps: "Databased Products", ssc4u: "https://www.hockeycomputindo.com/2020/07/free-point-of-sale-laravel-pos-source.html", acg: "Add Categories", ssc3u: "https://www.hockeycomputindo.com/2021/12/laravel-website-cms-source-code-full.html", cnpdt: " Create New Product", ssc5u: "https://www.hockeycomputindo.com/2020/09/aplikasi-toko-gratis-download.html", apd: "Add Products", soc: "Source Code Gallery →", resto: "https://www.hockeycomputindo.com/p/resto.html", shp : "Retail Shop App", shop: "https://www.hockeycomputindo.com/p/toko.html", ssc2u: "https://www.hockeycomputindo.com/2021/02/new-laravel-blog-cms-free-download.html", title: "Herry Store", rst: "Restaurant App", and: "Android Dev", opo: "Our Product", ssc1u: "https://www.hockeycomputindo.com/2020/09/larablog-laravel-cms-blog-with-seo.html", kasir: "POS Hardware", andro: "https://android.axcora.com", nav1: "Home", kasirs: "https://www.hockeycomputindo.com/p/daftar-mesin-kasir-terbaru.html", sslugu1: "https://www.hockeycomputindo.com/p/lavaapp-aplikasi-toko-grosir-dan-eceran.html", sslug1: "Lavapos", oss: "Our Services", socs: "https://www.hockeycomputindo.com/2010/12/blog-post.html", sslugu2: "https://www.hockeycomputindo.com/p/resto-cafe-website-modern-aplikasi.html", wbd: "Website Dev", sslug2: "Dexopos Resto", wbde: "https://website.axcora.com", sslugu3: "https://www.hockeycomputindo.com/p/website-keren-aplikasi-toko-android.html", lpor: "Laravel Pro", sslug3: "Dexopos Shop", sslugu4: "https://www.hockeycomputindo.com/p/new-restaurant-point-of-sale-pos-apps.html", sslug4: "Mr.Resto Pos", cc: "Create Categories", ddps: "Download all source code project", cn: "Categorie Name", nav3: "Data", cnct: "Create New Categories", sv: "Save Data", ctndb: "Categories databased", nav4: "POS", ncsa: "New Customer", inc: "Income", pro: "PRO", rpt: "Report", rptdm: "Report details menu", nav5: "Report", xpr: "Export Report", pap: "Premium App", db: "Database", papa: "https://lava.axcora.my.id/", dbs: "Register Database in here", pfc: "Profit Income", us: "User", gpr: "Group Report", pdpr: "Product Report", cs: "Customer", nus: "Create new user", usdb: "User Databased Management", usb: "User Report", cdmb: "Customer Databased Management", csr: "Customer Report", wba: "https://www.hockeycomputindo.com/p/webapp.html",}'>
    <div class="wrapper">
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark text-white"> <a class="navbar-brand" href="/"
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto p-1">
                    <li class="nav-item active"> <a href="{{route('home')}}" class="nav-link" x-text="nav1"> <svg
                                class="bi bi-grid-1x2" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor"
                    ...
                    <li class="nav-item active"> <a href="{{route('data')}}" class="nav-link" x-text="nav3"> <svg
                    ...
                    <li class="nav-item active"> <a href="{{route('sales.create')}}" class="nav-link" x-text="nav4">
                            ...
                            </svg> Point of sale </a> </li>
                    <li class="nav-item active"> <a href="{{route('office')}}" target="blank" class="nav-link"
                            x-text="nav5">
                            <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-controller"
                    ...
                    <li class="nav-item active">
                        <form action="{{route('logout')}}" method="POST">@csrf <button
                                onclick="return confirm('Yakin akan log out ?')" type="submit"
                                class="btn btn-outline-danger ml-4"> <svg class="bi bi-exclamation-circle-fill"
